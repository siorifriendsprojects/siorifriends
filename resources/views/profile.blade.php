...
<div  class="container-fluid">
	...
	<div class="row">
		<div class="col-xs-12"><img src="img/doraemon_face.jpg" width="80" height="80" alt="アイコン" class="img-circle center-block"></div>
	</div>
	...
	<div class="row">
	 ...
	 <div class="row">
		<div class="pr   col-xs-8 col-xs-offset-2  " text align="left" >うわーーー！　うぇひひひひ　いひひひ　あははは　あははは　うぃひひひひ　あーはー！　うぉー！うわああああああああ！　しゃべったああああああああ！
		</div>
	</div>
  </div>
  ...
  <hr/>
<div>本棚</div>
    <div class="col-xs-12 container　center-block">
            ...
            <div class="col-xs-3 obj">
                <div class="col-xs-12">
                    <div class="book_shadow">
                        <div class="book">
                            <div class="booktitle_space">
                            <span class="booktitle">世界の門地</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-3 obj">
                <div class="col-xs-12">
                    <div class="book_shadow">
                        <div class="book">
                            <div class="booktitle_space">
                            <span class="booktitle">門地の世界</span>
                            </div>
                        </div>
                    </div>
                </div>
