...
@section('content')
    ...
    <div class="container">
        <div class='col-xs-offset-1 col-xs-10' id='input-item'>
            <!-- 名前のグループ -->
        <form action="/editprofile" method="post" class="form-horizontal col-xs-offset-1 col-xs-10">
            ...
            <div class="form-group left-block">
                ...
                <input type="date" name="calender" min="1900-12-31" max="{{ date('Y-m-d') }}" class="form-control">
            </div>
            <!-- 性別のグループ -->
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="intro" name="intro" class="form-control" style="resize : none;"></textarea>
            </div>
            <!-- twitterのグループ -->
            <!-- facebookのグループ -->
            <!-- instagramのグループ -->
